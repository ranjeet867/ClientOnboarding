...
@section('content')
    ...
    <div class="col-lg-8 col-lg-offset-2 well">
        <div class="row">
            ...
            @endif
            {!! Form::open(['url'=>'clients', 'id'=>'addClient', 'method' => 'post']) !!}
            <div class="col-sm-12">
                <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date" data-provide="datepicker" data-date-format="mm/dd/yyyy">
                        <input type="text" placeholder="mm/dd/yyyy" name="dob" class="form-control" required="required"
                               value="{{ old('dob') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="tel" name="mobile" value="{{ old('mobile') }}" placeholder="Enter Phone Number Here.."
                           class="form-control" pattern='^\+?\d{0,13}' title='Phone Number (Format: +911234567890'
                           required="required">
                </div>
                <div class="form-group *">
                    <label>Email Address</label>
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="Enter Email Address Here.."
                           class="form-control" required="required">
                </div>
                <div class="form-group *">
                    <label>Nationality</label>
                    <input type="text" value="{{ old('nationality') }}" name="nationality"
                           placeholder="Enter Nationality Here.." class="form-control" required="required">
                </div>
                <div class="form-group">
                    <label>Address *</label>
                            ...
                            <div class="col-sm-6">
                                <label class="radio-inline">
                                    <input name="gender" value="Male" type="radio"
                                           required="required" {{ (old("gender") == "Male" ? "checked":"") }}>Male
                                </label>
                            </div>
                            <div class="col-sm-6">
                                <label class="radio-inline">
                                    <input name="gender" value="Female" type="radio"
                                           required="required" {{ (old("gender") == "Female" ? "checked":"") }}>Female
                                </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6 form-group">
                        <label>Country *</label>
                        <select id="inputCountry" class="form-control" required="required" name="country">
                    ...
                    <div class="col-sm-6 form-group">
                        <label>City *</label>
                        <input type="text" name="city" value="{{ old('city') }}" placeholder="Enter City Name Here.."
                               class="form-control" required="required">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-6 form-group">
                        <label>State *</label>
                        <input type="text" name="state" value="{{ old('state') }}" placeholder="Enter State Name Here.."
                               class="form-control" required="required">
                    </div>
                    <div class="col-sm-6 form-group">
                        <label>Zip *</label>
                        <input type="text" name="zip" value="{{ old('zip') }}" placeholder="Enter Zip Code Here.."
                               class="form-control" required="required">
                    </div>
                </div>
                <div class="row">
                ...
                <div class="form-group" id="EducationFields">
                    <div class="form-group row">
                        <div class="col-xs-4">
                            <input type="text" class="form-control" name="education[0][college]" placeholder="College"
                                   value="{{ old('education.0.college') }}" required="required"/>
                        </div>
                        <div class="col-xs-4">
                            <input type="text" class="form-control" name="education[0][degree]" placeholder="Degree"
                                   value="{{ old('education.0.degree') }}" required="required"/>
                        </div>
                        <div class="col-xs-2">
                            <input type="number" class="form-control" name="education[0][year]" placeholder="Year"
                                   value="{{ old('education.0.year') }}" required="required" min="1900"/>
                        </div>
                        <div class="col-xs-1">
                    ...
                    @php ($check = true)
                    @while ($check)
                        @if (old('education.'.$i.'.year') or old('education.'.$i.'.degree') or old('education.'.$i.'.college'))
                            <div class="form-group row" id="{{ $i }}">
                                <div class="col-xs-4">
                                    <input type="text" class="form-control" name="education[0][college]" placeholder="College"
                                           value="{{ old('education.'.$i.'.college') }}" required="required"/>
                                </div>
                                <div class="col-xs-4">
                                    <input type="text" class="form-control" name="education[0][degree]" placeholder="Degree"
                                           value="{{ old('education.'.$i.'.degree') }}" required="required"/>
                                </div>
                                <div class="col-xs-2">
                                    <input type="number" class="form-control" name="education[0][year]" placeholder="Year"
                                           value="{{ old('education.'.$i.'.year') }}" required="required" min="1900"/>
                                </div>
                                <div class="col-xs-1">
